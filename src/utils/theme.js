export default {
    colors: {
        ...
        backgroundBoard: "#F8F8FA",
        backgroundCard: "#FFFFFF",
        backgroundHeader: "#FFFFFF",
        backgroundPromo: "#F9A52B",
        activeButton: "#4460F7",
        hoverButton: "#2140E8",
        inactiveButton: "#9194A5",
        inputBorder: "#E0E2EA",
        ...
        userDropdownShadow: "rgba(17, 18, 20, 0.2)",
        modalBackground: "rgba(26, 27, 29, .9)",
    ...
    buttonColors: {
        ...
        normalWhiteButton: {
            ...
            textColor: "#4460F7",
            hoverTextColor: "#2140E8",
            hoverBorderColor: "#2140E8"
        },
    },
    wrappers: {
        desktop: `1440px`
